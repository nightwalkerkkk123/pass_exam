...
- 父目录 `/Users/wangzihao/Code/pass_exam/` 是学习上下文：
  ...
  - `operating_systems/operating_systems_tangxiaodan/`: **教材内容技能**（2026-06-10 加入）
    - `SKILL.md`: 12 章结构化索引
...
- 课时：`operating_systems/lessons/0013-java-two-exercises-zero-to-hero.html`（零基础逐行讲解 + 自测 5 题）
- 与 OS mission 无关，属跨主题加餐；代码在 Desktop/tmp

## 源码精讲专题（2026-06-13，老师必讲算成绩）
- 位置：`operating_systems/linux/`（6 节课，1 周专题）
